 ...
 */
class BankRecord extends RecordAbstract {
    ...
    protected $sqlInsert = "INSERT INTO bank (id, nama, label) VALUES (:id, :nama, :label)";
    protected $sqlSelect = "SELECT id, nama, label FROM bank WHERE id = :id";
    protected $sqlUpdate = "UPDATE bank SET nama = :nama, label = :label WHERE id = :id";
    protected $sqlDelete = "DELETE FROM bank WHERE id = :id";
