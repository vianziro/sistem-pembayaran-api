 ...
 */
class UnitRecord extends RecordAbstract {
    ...
    protected $sqlInsert = "INSERT INTO unit (id, nama, label) VALUES (:id, :nama, :label)";
    protected $sqlSelect = "SELECT id, nama, label FROM unit WHERE id = :id";
    protected $sqlUpdate = "UPDATE unit SET nama = :nama, label = :label WHERE id = :id";
    protected $sqlDelete = "DELETE FROM unit WHERE id = :id";
