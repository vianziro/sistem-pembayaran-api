 ...
 */
class ProgramRecord extends RecordAbstract {
    ...
    protected $sqlInsert = "INSERT INTO program (id, nama, label) VALUES (:id, :nama, :label)";
    protected $sqlSelect = "SELECT id, nama, label FROM program WHERE id = :id";
    protected $sqlUpdate = "UPDATE program SET nama = :nama, label = :label WHERE id = :id";
    protected $sqlDelete = "DELETE FROM program WHERE id = :id";
