 ...
 */
class JurusanRecord extends RecordAbstract {
    ...
    protected $sqlInsert = "INSERT INTO jurusan (id, nama, label) VALUES (:id, :nama, :label)";
    protected $sqlSelect = "SELECT id, nama, label FROM jurusan WHERE id = :id";
    protected $sqlUpdate = "UPDATE jurusan SET nama = :nama, label = :label WHERE id = :id";
    protected $sqlDelete = "DELETE FROM jurusan WHERE id = :id";
