...
/**
 * Unit test objek KasirRecord.
 *
 * @author Andi Malik <andi.malik.notifications@gmail.com>
 */
class KasirRecordUnitTest extends PHPUnit_Framework_TestCase {
     ...
     * @group unitTest
     * @group recordObject
     * @covers KasirRecord::setId()
     * @covers KasirRecord::getId()
     * @covers KasirRecord::unsetId()
     */
     ...
     * @group unitTest
     * @group recordObject
     * @covers KasirRecord::setNama()
     * @covers KasirRecord::getNama()
     * @covers KasirRecord::unsetNama()
     */
     ...
     * @group unitTest
     * @group recordObject
     * @covers KasirRecord::setPDO()
     * @covers KasirRecord::getPDO()
     * @covers KasirRecord::unsetPDO()
     */
    ...
    public function testRetrieveReturnFalseJikaCloseCursorGagal() {
        ...
        $mockPDOStatement->expects($this->any())->method("execute")->with($this->isType("array"))->will($this->returnValue(TRUE));
        $mockPDOStatement->expects($this->any())->method("fetch")->with($this->equalTo(PDO::FETCH_ASSOC))->will($this->returnValue(array("id" => 1, "nama" => "A")));
    ...
    public function testOperasiRetrieveSukses() {
        $fetchReturnValue = array("id" => 1, "nama" => "A");
