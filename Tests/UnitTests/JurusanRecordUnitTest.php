...
/**
 * Unit test objek JurusanRecord.
 *
 * @author Andi Malik <andi.malik.notifications@gmail.com>
 */
class JurusanRecordUnitTest extends PHPUnit_Framework_TestCase {
     ...
     * @group unitTest
     * @group recordObject
     * @covers JurusanRecord::setId()
     * @covers JurusanRecord::getId()
     * @covers JurusanRecord::unsetId()
     */
     ...
     * @group unitTest
     * @group recordObject
     * @covers JurusanRecord::setNama()
     * @covers JurusanRecord::getNama()
     * @covers JurusanRecord::unsetNama()
     */
     ...
     * @group unitTest
     * @group recordObject
     * @covers JurusanRecord::setLabel()
     * @covers JurusanRecord::getLabel()
     * @covers JurusanRecord::unsetLabel()
     */
     ...
     * @group unitTest
     * @group recordObject
     * @covers JurusanRecord::setPDO()
     * @covers JurusanRecord::getPDO()
     * @covers JurusanRecord::unsetPDO()
     */
