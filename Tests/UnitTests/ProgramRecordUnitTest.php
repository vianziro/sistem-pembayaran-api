...
/**
 * Unit test objek ProgramRecord.
 *
 * @author Andi Malik <andi.malik.notifications@gmail.com>
 */
class ProgramRecordUnitTest extends PHPUnit_Framework_TestCase {
     ...
     * @group unitTest
     * @group recordObject
     * @covers ProgramRecord::setId()
     * @covers ProgramRecord::getId()
     * @covers ProgramRecord::unsetId()
     */
     ...
     * @group unitTest
     * @group recordObject
     * @covers ProgramRecord::setNama()
     * @covers ProgramRecord::getNama()
     * @covers ProgramRecord::unsetNama()
     */
     ...
     * @group unitTest
     * @group recordObject
     * @covers ProgramRecord::setLabel()
     * @covers ProgramRecord::getLabel()
     * @covers ProgramRecord::unsetLabel()
     */
     ...
     * @group unitTest
     * @group recordObject
     * @covers ProgramRecord::setPDO()
     * @covers ProgramRecord::getPDO()
     * @covers ProgramRecord::unsetPDO()
     */
