...
/**
 * Unit test objek UnitRecord.
 *
 * @author Andi Malik <andi.malik.notifications@gmail.com>
 */
class UnitRecordUnitTest extends PHPUnit_Framework_TestCase {
     ...
     * @group unitTest
     * @group recordObject
     * @covers UnitRecord::setId()
     * @covers UnitRecord::getId()
     * @covers UnitRecord::unsetId()
     */
     ...
     * @group unitTest
     * @group recordObject
     * @covers UnitRecord::setNama()
     * @covers UnitRecord::getNama()
     * @covers UnitRecord::unsetNama()
     */
     ...
     * @group unitTest
     * @group recordObject
     * @covers UnitRecord::setLabel()
     * @covers UnitRecord::getLabel()
     * @covers UnitRecord::unsetLabel()
     */
     ...
     * @group unitTest
     * @group recordObject
     * @covers UnitRecord::setPDO()
     * @covers UnitRecord::getPDO()
     * @covers UnitRecord::unsetPDO()
     */
